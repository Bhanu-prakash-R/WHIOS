...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleSaleNotFoundException(SaleNotFoundException ex, WebRequest request) {
    ...
    public ResponseEntity<?> handleInvalidSaleRequestException(InvalidSaleRequestException ex, WebRequest request) {
        ErrorDetails errorDetails = new ErrorDetails(ex.getMessage(), request.getDescription(false));
